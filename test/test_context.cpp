...
void f1( ctx::transfer_t t) {
    ++value1;
    ctx::jump_fcontext( t.ctx, t.data);
}

void f3( ctx::transfer_t t_) {
    ++value1;
    ctx::transfer_t t = ctx::jump_fcontext( t_.ctx, 0);
    ++value1;
    ctx::jump_fcontext( t.ctx, t.data);
}

void f4( ctx::transfer_t t) {
    ctx::jump_fcontext( t.ctx, 7);
}
...
void f6( ctx::transfer_t t_) {
    ...
    ctx::transfer_t t = ctx::jump_fcontext( t_.ctx, ( intptr_t) res);
    data = * ( std::pair< int, int > *) t.data;
    res = data.first + data.second;
    ctx::jump_fcontext( t.ctx, ( intptr_t) res);
}

void f7( ctx::transfer_t t) {
    try {
        throw std::runtime_error( ( char *) t.data);
...
void test_transfer() {
    ...
    BOOST_CHECK( ctx);
    ctx::transfer_t t = ctx::jump_fcontext( ctx, ( intptr_t) & data);
    int result = ( int) t.data;
    BOOST_CHECK_EQUAL( 10, result);
    data = std::make_pair( 7, 7);
    t = ctx::jump_fcontext( t.ctx, ( intptr_t) & data);
    result = ( int) t.data;
...
void test_exception() {
    ...
    BOOST_CHECK( ctx);
    ctx::jump_fcontext( ctx, ( intptr_t) what);
...
void test_fp() {
    ...
    BOOST_CHECK( ctx);
    ctx::jump_fcontext( ctx, (intptr_t) & d);
